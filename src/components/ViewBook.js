   ...
   <div className=' d-flex justify-content-center m-5'>
    ...
    <div style={{ width: "18rem"}} className=" d-flex justify-content-center">
                ...
                <div >
                    ...
                    <Link to={`/portal/edit-book/${viewBook.id}`} > <button  class="btn mb-2 text-white "  style={{backgroundColor:"#b2bec3"}}>Edit</button> </Link>
                     <button  class="btn mb-2 text-white"  style={{backgroundColor:"#b2bec3"}} onClick ={()=>{
